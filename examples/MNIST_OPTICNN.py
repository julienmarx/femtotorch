...
class OptiCnnNet:
    ...
    def __call__(self, X):
        ...
        x = self.conv1(X.reshape(-1, 1, 28, 28)).relu() # the -1 allows flexibility on the last batch 
...
# save weights
ft.save("checkpoints_weights/MNIST_OPTICNN.npz", params_list, overwrite=False)
...
ft.load("checkpoints_weights/MNIST_OPTICNN.npz", params_list2)
